...
public class DeleteElements{
    public boolean deleteCars(ObservableList selectedElements) throws IOException {
        ...
        if (selectedElements.size() > 0) {
            ...
            throw new IOException("You have to choose a car to delete");
        }
        return true;
    }
    ...
    public boolean deleteComponents(ObservableList<Component> selectedElements) throws IOException {
        ...
        if (selectedElements.size() > 0) {
            ...
            throw new IOException("You have to choose a component to delete");
        }
        return true;
    }
    public ObservableList<Adjustment> deleteAdjsutments(ObservableList allElements, ObservableList selectedElements) throws IOException {
        return null;
    }
}
